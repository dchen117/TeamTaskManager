...
import { useSwitchWorkspace } from "@/hooks/useSwitchWorkspace.js"
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              {workspaces.map((workspace, index) => (
                <DropdownMenuItem key={workspace._id} onClick={() => switchWorkspace(workspace._id)} className="gap-2 p-2">
              ...
              <DropdownMenuItem className="gap-2 p-2">
                ...
                <div className="font-medium text-muted-foreground" onClick={() => setOpenCreateWorkspace(true)}>Add workspace</div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </SidebarMenuItem>
      </SidebarMenu>
      <AddWorkspaceDialog open={openCreateWorkspace} onOpenChange={setOpenCreateWorkspace} />
    </>
  );
}
